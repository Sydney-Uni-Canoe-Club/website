<?php
$titulo = "My Trips Edit";
include_once './_top.php';



if ($_SESSION["tipo_usuario"] == 2 && isset($_GET["id"]) == false) {

    header('Location: ./home.php');
    die();
}

$sql = "select *  from eventos where id=" . $_GET["id"] . " and husuario=" . $_SESSION["usr_id"];
            ...
            <div class="col-12"> <!-- Default box -->
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" action="./mytrips_edit2.php">
                            <div class="row">
                                <div class="col-12">
                                    <a class="btn btn-primary"
                                        href="./mytrips_notify_email.php?redirect=mytrips_edit.php?id=<?php echo $_GET['id']; ?>&id=<?php echo $_GET['id']; ?> "
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control" id="date2" name="date2"
                                        ...
                                        value="<?php echo $fila["fecha_fin"]; ?>" placeholder="optional date">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    if ($fila['img'] != '') {
                                        ...
                                        <a class="btn btn-danger"
                                            href="./main_img_delete.php?id=<?php echo $fila['id']; ?>&redic=mytrips_edit.php"
                                            role="button" aria-expanded="false" aria-controls="collapseExample">
                                            Delete Main Image
                                        </a>
                                        <?php
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <a class="btn btn-warning mb-2" href="./mytrips.php" role="button"
                        ...
                        <div class="col-12"> <!-- Default box -->
                            <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <a class="btn btn-primary"
                                            href="./email_trips.php?redirect=mytrips_edit.php?id=<?php echo $_GET['id']; ?>&id=<?php echo $_GET['id']; ?> "
                                            role="button" aria-expanded="false" aria-controls="collapseExample">
                                            Email everyone
                                        </a>
                                    </div>
                            ...
                            INNER JOIN usuarios u on u.id=eu.husuario where eu.hevento=" . $_GET["id"];
                                        ...
                                        aria-controls='collapseExample'>Open default email client</a>";
                                                ...
                                                echo '<td>   <a class="btn btn-warning" href="./mytrips_email_send.php?redirect=mytrips_edit.php?id=' . $_GET['id'] . '&email=' . $fila['correo'] . '" role="button" aria-expanded="false"
                ...
                <div class="row">
                    <div class="col-12"> <!-- Default box -->
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <form method="post" enctype="multipart/form-data" action="./mytrips_gallery.php">
                                        <div class="row">
                                            <div class="col-12">
                                        ...
                                        <table id="gallery_tb" name="gallery_tb">
                                            ...
                                            while ($fila = mysqli_fetch_assoc($result)) {
                                                ...
                                                <td> <a class="btn btn-danger"
                                                        href="./mytrips_gallery_delete.php?id=<?php echo $fila['id']; ?> "
                                                        role="button" aria-expanded="false" aria-controls="collapseExample">
                                                        delete
                                                    </a></td>
                                                <?php
            ...
            <div class="container-fluid"> <!--begin::Row-->
                ...
                INNER JOIN usuarios u on u.id=eb.husuario where eb.hevent=" . $_GET["id"];
                                            ...
                                            while ($fila = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td> <img class='expand-img img-fluid rounded float-left'   src='./uploads/comments/" . $fila['img'] . "' > </td>";
                                                echo "<td> ";
                                                ?>
                                            ...
                                            while ($fila = mysqli_fetch_assoc($result_attendes)) {
                                                ...
                                                <form method="post" enctype="multipart/form-data"
                                                    ...
                                                    <input type="hidden" name="husuario"
                                                        ...
                                                        <input type="hidden" name="hevent" value="<?php echo $fila['hevento']; ?>">
                                                    <input type="hidden" name="redir" value="mytrips_edit.php">
