...
$titulo = "Send Massive Email- Users";
            ...
            <div class="col-12"> <!-- Default box -->
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" action="./email_users2.php">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <a class="btn btn-warning mb-2" href="./admin_user.php" role="button"
