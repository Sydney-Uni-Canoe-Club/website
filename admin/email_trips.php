            ...
            <div class="col-12"> <!-- Default box -->
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" action="./email_trips2.php">
                            <div class="row">
                            ...
                            <br>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="hidden" id="hevento" name="hevento"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <a class="btn btn-warning mb-2" href="<?php echo $_GET["redirect"]; ?>" role="button"
