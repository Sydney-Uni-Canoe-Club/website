...
$sql = "INSERT INTO eventos(nombre, descripcion,  fecha_inicio, fecha_fin, cupo_limite, hcategory, husuario,img, status,hour, hour_end,location)
VALUES ('" . $_POST["name"] . "','" . $_POST["description"] . "','" . $_POST["date1"] . "','" . $_POST["date2"] . "','" . $_POST["coupons"] . "','" . $_POST["hcategory"] . "','" . $_SESSION["usr_id"] . "','$name_imgmain','" . $_POST["status"] . "','" . $_POST["hour"] . "','" . $_POST["hour_end"] . "','" . $_POST["location"] . "')";
...
if (count($_FILES["gallery"]['name']) > 0) {// Loop through each file
