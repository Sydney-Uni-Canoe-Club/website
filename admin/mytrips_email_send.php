...
$titulo = "Send Email - Trips - " . $_GET["email"];
            ...
            <div class="col-12"> <!-- Default box -->
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" action="./mytrips_email_send2.php">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <a class="btn btn-warning mb-2" href="./<?php echo $_GET["redirect"]; ?>"
