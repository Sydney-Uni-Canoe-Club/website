...
if ($_SESSION["tipo_usuario"] == 2 || isset($_POST) == false) {
...
status=" . $_POST["status"] . ", fecha_inicio='" . $_POST["date1"] . "' , fecha_fin='" . $_POST["date2"] . "', 
cupo_limite=" . $_POST["coupons"] . ", hcategory=" . $_POST["hcategory"] . ", hour='" . $_POST["hour"] . "', hour_end='" . $_POST["hour_end"] . "', location='" . $_POST["location"] . "' WHERE id=" . $_POST["id"];

mysqli_query($link, $sql);
$_SESSION["message"] = "Edited!";
header('Location: ./mytrips_edit.php?id=' . $_POST["id"]);
?>