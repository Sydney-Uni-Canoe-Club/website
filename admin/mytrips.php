            ...
            <div class="col-12"> <!-- Default box -->
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <a class="btn btn-primary" href="./mytrips_new.php" role="button" aria-expanded="false"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <table id="tabla_eventos" name="tabla_eventos">
                                    ...
                                    $sql = "select *, (select name from events_category ec where ec.id=hcategory) as category from eventos where husuario=" . $_SESSION["usr_id"];
                                    ...
                                    while ($fila = mysqli_fetch_assoc($result)) {
                                        ...
                                        <td>
                                            <div class="progress mb-2" role="progressbar"
                                                ...
                                                <div class="progress-bar"
                                                    style="width: <?php echo $progres; ?>%; border-radius: 0.375rem;">
                                                </div>
                                        ...
                                        echo '<td>   <a class="btn btn-warning" href="./mytrips_edit.php?id=' . $fila['id'] . '" role="button" aria-expanded="false"
                                    aria-controls="collapseExample">
                                   Edit
                                </a> 
                                <a class="btn btn-danger" href="./mytrips_delete.php?id='.$fila['id'].'" role="button" aria-expanded="false"
                                    aria-controls="collapseExample">
                                   Cancel Trip
                                </a></td>';
                                        echo "</tr>";
